...
def render_all_in_folder_on_template(
    ...
    template_pixel_array = template.get_array_of_pixels(
    ...
    for file in os.listdir(src_dir):
        ...
        template_pixel_array = Drawing._merge_array_on_background(
            arr=drawing.drawing, 
            r=drawing_color[0], g=drawing_color[1], b=drawing_color[2], 
            background_array=template_pixel_array
            )
    ...
    Drawing._render_array_to_png(
        pixelArr=template_pixel_array, 
        out_path=save_dir + "/" + file_name
        )
    
    return template_pixel_array
...
if __name__ == "__main__":
    render_all_in_folder_on_template(
        ...
        drawing_color=[0,0,0], template_color=[0,255,0], background_color=[255,255,255],
        render_dominant=None
        )